export const TRANSLATIONS = {
  es: {
    ...
    fullscreenTooltip: "Pantalla Completa (Visualizar y exportar)",

    // Fullscreen modal & controls
    fullscreenTitle: "Vista en Pantalla Completa",
    fullscreenClose: "Cerrar pantalla completa (Esc)",
    fullscreenZoomIn: "Aumentar zoom (+)",
    fullscreenZoomOut: "Reducir zoom (-)",
    fullscreenResetZoom: "Restablecer zoom (100%)",
    fullscreenPanUp: "Mover hacia arriba (↑)",
    fullscreenPanDown: "Mover hacia abajo (↓)",
    fullscreenPanLeft: "Mover hacia la izquierda (←)",
    fullscreenPanRight: "Mover hacia la derecha (→)",
    fullscreenPanCenter: "Centrar vista",
    fullscreenExportBtn: "Exportar Imagen",
    fullscreenExportBg: "Exportar PNG (Con fondo)",
    fullscreenExportTransparent: "Exportar PNG (Transparente)",
    fullscreenExportSuccess: "Imagen exportada exitosamente",
    fullscreenHelpHint: "Arrastra con el ratón o usa las flechas del teclado para moverte. Usa la rueda para hacer zoom.",

    // Fullscreen settings
    sectionFullscreen: "Modo Pantalla Completa",
    fullscreenNavButtonsName: "Botones de flechas direccionales",
    fullscreenNavButtonsDesc: "Muestra los controles direccionales flotantes (D-pad) en la pantalla completa.",
    fullscreenZoomButtonsName: "Botones de zoom (+ / -)",
    fullscreenZoomButtonsDesc: "Muestra los botones de control de zoom en la pantalla completa.",
    btnOptAlways: "Siempre visible (Escritorio y Móvil)",
    btnOptMobile: "Solo en dispositivos móviles",
    btnOptNever: "Desactivado / No mostrar",
    enableOverflowPulseName: "Alerta visual de desbordamiento",
    enableOverflowPulseDesc: "Hace parpadear el botón de pantalla completa cuando el diagrama sobrepasa el ancho del bloque.",
    overflowPulseColorName: "Color del parpadeo de desbordamiento",
    overflowPulseColorDesc: "Elige el color del resplandor y parpadeo del botón de pantalla completa cuando haya overflow.",
  },
  en: {
    // Language setting
    langSettingName: "Idioma / Language",
    ...
    fullscreenTooltip: "Fullscreen (View and export)",

    // Fullscreen modal & controls
    fullscreenTitle: "Fullscreen View",
    fullscreenClose: "Close fullscreen (Esc)",
    fullscreenZoomIn: "Zoom In (+)",
    fullscreenZoomOut: "Zoom Out (-)",
    fullscreenResetZoom: "Reset Zoom (100%)",
    fullscreenPanUp: "Pan Up (↑)",
    fullscreenPanDown: "Pan Down (↓)",
    fullscreenPanLeft: "Pan Left (←)",
    fullscreenPanRight: "Pan Right (→)",
    fullscreenPanCenter: "Center View",
    fullscreenExportBtn: "Export Image",
    fullscreenExportBg: "Export PNG (With background)",
    fullscreenExportTransparent: "Export PNG (Transparent)",
    fullscreenExportSuccess: "Image exported successfully",
    fullscreenHelpHint: "Drag with mouse or use arrow keys to pan. Use mouse wheel to zoom.",

    // Fullscreen settings
    sectionFullscreen: "Fullscreen Mode",
    fullscreenNavButtonsName: "Directional Arrow Controls",
    fullscreenNavButtonsDesc: "Display floating directional arrow controls (D-pad) in fullscreen mode.",
    fullscreenZoomButtonsName: "Zoom Controls (+ / -)",
    fullscreenZoomButtonsDesc: "Display zoom buttons in fullscreen mode.",
    btnOptAlways: "Always visible (Desktop and Mobile)",
    btnOptMobile: "Mobile devices only",
    btnOptNever: "Disabled / Do not show",
    enableOverflowPulseName: "Overflow Visual Alert",
    enableOverflowPulseDesc: "Pulsates and glows the fullscreen button when diagram content overflows the codeblock.",
    overflowPulseColorName: "Overflow Pulse Color",
    overflowPulseColorDesc: "Choose the glow and pulse color for the fullscreen alert button.",
  }
};
